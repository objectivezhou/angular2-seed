...
var AppModuleInjector = (function (_super) {
    ...
    function AppModuleInjector(parent) {
        _super.call(this, parent, [import18.AppNgFactory], [import18.AppNgFactory]);
    }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgLocalization_10", {
        get: function () {
            if ((this.__NgLocalization_10 == null)) {
                (this.__NgLocalization_10 = new import8.NgLocaleLocalization(this._LOCALE_ID_9));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ErrorHandler_3 = import4.errorHandler();
        this._ApplicationInitStatus_4 = new import5.ApplicationInitStatus(this.parent.get(import5.APP_INITIALIZER, null));
        this._Testability_5 = new import6.Testability(this.parent.get(import22.NgZone));
        this._ApplicationRef__6 = new import7.ApplicationRef_(this.parent.get(import22.NgZone), this.parent.get(import24.Console), this, this._ErrorHandler_3, this, this._ApplicationInitStatus_4, this.parent.get(import6.TestabilityRegistry, null), this._Testability_5);
        this._ApplicationRef_7 = this._ApplicationRef__6;
        this._AppModule_8 = new import1.AppModule(this._ApplicationRef_7);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import6.Testability)) {
            return this._Testability_5;
        }
        if ((token === import7.ApplicationRef_)) {
            return this._ApplicationRef__6;
        }
    ...
    AppModuleInjector.prototype.destroyInternal = function () {
        this._ApplicationRef__6.ngOnDestroy();
    };
